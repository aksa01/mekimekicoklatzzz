		...
		function stopLoading(bool){
			...
			text: "Terimakasih Telah Menggunakan NBA Checker !",
			html: true,
		...
		function GbrnTmfn(lstMP, lstSock, curMP, curSock, delim, cEmail, bank, card, info, maxFail, failed, no){
			...
			ajaxCall = $.ajax({
				...
				beforeSend: function (e) {
					updateTitle('['+no+'/'+lstMP.length+'] MaidchanChecker - 2k17');
		...
		$(document).ready(function(){
			...
			$('#submit').click(function(){
				...
				allowOutsideClick: true,
				type: "error",
				text: "Mohon Tempatkan Email Dan Password Dengan Benar!",
				confirmButtonText: "Kembali"
				     });
				return false;
				} 
